        ...
        <div class="footer-container2">
            ...
            <nav class="footer-section2" aria-label="Help and support">
                ...
                <ul class="footer-links2">
                    <li><a href="/contact" class="footer-link2">Hubungi Kami</a></li>
            ...
            <nav class="footer-section2" aria-label="Educational programs">
                ...
                <ul class="footer-links2">
                    <li><a href="#" class="footer-link2">Seni & Desain</a></li>
                    <li><a href="#" class="footer-link2">Business</a></li>
                    <li><a href="#" class="footer-link2">IT & Software</a></li>
                    <li><a href="#" class="footer-link2">Languages</a></li>
                    <li><a href="#" class="footer-link2">Programming</a></li>
                </ul>
            </nav>
            ...
            <div class="footer-section2">
                ...
                <address class="contact-info2">
                    JL.Raya Bromo No.32<br>
                    Probolinggo,Jawa Timur IND<br>
                    <a href="tel:+6282139049378" class="footer-link2">+62 821-3904-9378</a><br>
                ...
                <div class="social-links2">
                    ...
                    <a href="https://www.instagram.com/radhikakemal?igsh=aW1yajZvcGJweDl3" class="social-link2" aria-label="Visit our Instagram page">
                        <svg class="social-icon2" aria-hidden="true" viewBox="0 0 24 24"></svg>
                    </a>
